...
public final class UpgradeMenuTowerBasicDrawer implements DrawableMenu {

    private static final Texture TEXTURE = new Texture(Assets.MENU_UPGRADEMENU_TOWERBASIC);
