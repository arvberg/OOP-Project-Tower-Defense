...
public final class TowerBasicIconDrawer implements DrawableButton, InputListener {
    ...
    private static final Texture TEXTURE_MENU = new Texture(Assets.MENU_INFOMENU_TOWERBASIC);
