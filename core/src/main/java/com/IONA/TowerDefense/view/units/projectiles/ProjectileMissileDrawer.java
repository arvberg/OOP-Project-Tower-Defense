...
public final class ProjectileMissileDrawer implements DrawableProjectile {

    private final Projectile projectile;
    private Vector2 p;

    private static final Texture TEXTURE = new Texture(Assets.PROJECTILE_MISSILE);
    private static final TextureRegion TEXTURE_R = new TextureRegion(TEXTURE);

    public ProjectileMissileDrawer(Projectile projectile) {
