...
public final class UpgradeMenuTowerPulseDrawer implements DrawableMenu {

    private static final Texture TEXTURE = new Texture(Assets.MENU_UPGRADEMENU_TOWERPULSE);
    ...
    public UpgradeMenuTowerPulseDrawer(UpgradeMenu upgradeMenu) {
    ...
    public void draw(SpriteBatch batch, ShapeRenderer shapeRenderer, float delta) {
        if (upgradeMenu.towerIsClicked()) {
            ...
            font1.draw(batch, "N.I.P", x + 0.2f, y + height - 0.2f);
